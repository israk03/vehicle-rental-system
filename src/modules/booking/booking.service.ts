...
const checkVehicleAvailability = async (vehicleId: number)=>{
...
const calculateTotalPrice = async(vehicleId: number, startDate: string, endDate: string)=>{
    ...
    const dailyRate = parseFloat(vehicleResult.rows[0].daily_rent_price);
...
const updateBookingStatus = async (bookingId: number, status: string) => {
    ...
    try {
        ...
        // If status is returned or cancelled, update vehicle to available
